...
<Header company="IBM" platformName="Carbon Svelte" bind:isSideNavOpen expansionBreakpoint={5000}>
...
<SideNav bind:isOpen={isSideNavOpen} rail expansionBreakpoint={5000}>
	<SideNavItems>
